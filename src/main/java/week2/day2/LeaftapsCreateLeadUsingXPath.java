...
public class LeaftapsCreateLeadUsingXPath {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		// Click Lastname
		 ...
		 Select selectMarketing = new Select(marketing); selectMarketing.selectByIndex(2); 
		 //Enter first name
		 ...
		 Select ownSelect = new Select(own); ownSelect.selectByVisibleText("Public Corporation"); 
		 //Enter SIC Code
